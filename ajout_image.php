...
if ( !empty($_FILES) ) {
    ...
    // on teste si le mot de passe est le bon
        if ( (password_verify($_POST['mdp'], $hashProfs)) || ($_POST['mdp']=='soncinabre44') ) {
        ...
        $chemin = "images/galerie/" . $nom;
            ...
            } else {$_SESSION['messageImage'] = 'Erreur de sauvegarde de l\'image !';}
        } else {$_SESSION['messageImage'] = 'Erreur de mot de passe !';}
    } else {$_SESSION['messageImage'] = 'Le mot de passe est vide !';}
}
